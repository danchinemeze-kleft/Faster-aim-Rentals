...
function AccountPageInner() {
  ...
  const handleSignup = async (e) => {
    ...
    // Auto-confirmed — insert into Profiles
    if (data.user) {
  ...
  return (
    <main className="faim-account-page">
      ...
      <style>{`
        ...
        .faim-google-btn:hover {
          background: #f8f8f8;
          border-color: #bbb;
        }

        .faim-google-btn:disabled {
          opacity: 0.6;
          cursor: not-allowed;
        }
        ...
        .faim-submit-btn:hover {
          background: #cf6d17;
        }

        .faim-submit-btn:disabled {
          opacity: 0.6;
          cursor: not-allowed;
        }
