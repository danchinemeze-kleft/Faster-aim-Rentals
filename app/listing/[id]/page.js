...
export default function ListingPage() {
  ...
  // Capture affiliate ref code if arrived directly on listing page
  useEffect(() => {
    try {
  ...
  async function proceedWithReveal() {
    ...
    try {
      ...
      const refCode = (typeof window !== 'undefined' && localStorage.getItem('mrRentAffiliate')) || document.cookie.match(/mrrent_ref=([^;]+)/)?.[1] || null
