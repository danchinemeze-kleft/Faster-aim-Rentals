      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          .hero-layout-light { flex-direction: column !important; }
          .hero-title-light { font-size: 2rem !important; }
          .steps-grid-light { grid-template-columns: 1fr 1fr !important; }
          .landlord-content-light { flex-direction: column !important; }
          .avatar-container-light { width: 260px !important; height: 300px !important; }
        }
      `}</style>
    </main>
  )
...
const s = {
  ...
  btnCyan: {
    ...
    color: '#ffffff', padding: '0.875rem 2rem',
  ...
  btnOutline: {
    ...
    border: `2px solid ${CYAN}`, boxShadow: `0 4px 16px ${CYAN}22`,
  },
