...
export default function DashboardPage() {
  ...
  const toggleAvailability = async (listing) => {
    ...
    if (!error) {
      ...
      setStats(prev => ({
        ...prev,
        available: !listing.available ? prev.available + 1 : prev.available - 1
      }))
    }
    setTogglingId(null)
  }
          ...
          <div className="faim-overview">
            ...
            <div className="faim-stats-grid">
              <div className="faim-stat-card">
                ...
                <div>
                  <p className="faim-stat-value">{stats.total}</p>
                  <p className="faim-stat-label">Total Listings</p>
                </div>
              </div>
              <div className="faim-stat-card">
                <div className="faim-stat-icon">✅</div>
                <div>
                  <p className="faim-stat-value">{stats.available}</p>
                  <p className="faim-stat-label">Available Now</p>
                </div>
              </div>
              <div className="faim-stat-card">
                <div className="faim-stat-icon">👁️</div>
                <div>
                  <p className="faim-stat-value">{stats.reveals}</p>
                  <p className="faim-stat-label">Contact Reveals</p>
                </div>
              </div>
              <div className="faim-stat-card">
                <div className="faim-stat-icon">💰</div>
                <div>
                  <p className="faim-stat-value">₦{(stats.reveals * 5000).toLocaleString()}</p>
                  <p className="faim-stat-label">Revenue Generated</p>
                </div>
              </div>
            </div>
              ...
              {listings.slice(0, 3).map(listing => (
                <div key={listing.id} className="faim-listing-row">
                  ...
                  <div className="faim-toggle-wrap">
                    ...
                    <button
                      className={`faim-toggle ${listing.available ? 'faim-toggle--on' : 'faim-toggle--off'}`}
